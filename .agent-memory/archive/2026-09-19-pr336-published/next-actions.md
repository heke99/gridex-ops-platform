...
1. Recover a writable GitHub/CLI route; preserve this exact candidate.
2. Fresh main/ref inspection, apply on real ancestry, publish candidate PR.
3. Four normal workflows and substantive independent review of the same head/base.
4. Repair findings, repeat tests/review; guarded merge only after acceptance.
5. Update actual receipt in333, then remaining D/parent/address/source units.
