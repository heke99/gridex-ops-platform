# PR372 correction capture — canonical permission repair approved

Current published90a9bd63326dffd2bf5f37568e093a4fd4d349d6 ran native196PASS/8FAIL of204 in OPS35936657744/job107435085499; profile binding fixed, then actual permission mismatch discovered. communication.write does not exist in canonical catalog; new capture could not authorize ordinary actors. Separate negative fixture violated last-admin invariant. Full quality/build passed, generated-types gate remains pending actual artifacts. No native acceptance.

Fixround3 local8ebbac3f6f2eb82fafff46d013bedba7cc1a5764 is independently SPEC/QUALITY approved. Action and CLI-created forward20260924001447 use existing communication.send, with no new permission/alias/role grants/testing fallback. All other SQL/source/actor/company/witness controls remain byte-equivalent. Published231731 unchanged. Real permission preconditions and separate limited actors/paused-company zero-write cases added. Final71/4,3types/lint/integrity609/513PASS; expectednative206 NOT EXECUTED. Parent publishes exact reviewed tree next. Record source reports and permission amendment in E035 audit directory.

Task2 source-only capture remains incomplete until genuine native qualification. Task2b reference-only documents (additional documents.read/customers.read), Task3 bounded partial history and Task4 conditional single-MVCC UTILTS composition remain pending. Approved designs, exact producer inventory and streaming-I/O preflight saved. New epoch alone must not hold unrelated ordinary supplies; no positive C/basis/reopening authority. PR371 accepted merged2a148d39; PR310 excluded; E035 remainsPARTIAL.

Next: publish permission fix, inspect native206 and actual generated artifacts, repair genuine failures under scoped review and preserve published migrations. User continuation/publication/CI/gated-merge approval persists. No hosted writes/deployment/market sends.
