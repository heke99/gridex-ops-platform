# PR372 active — immutable correction source capture

Authoritative accepted baseline: PR371 merged 2a148d39d631fc759c99cd1c69350b5e2147dbdb after final-head full 6003 tests, native 166 and all applicable CI plus independent SPEC/QUALITY/native acceptance. Do not restart PR370/371. PR310 remains paused and excluded.

PR372 draft: https://github.com/heke99/gridex-ops-platform/pull/372, branch codex/e035-correction-context-20260924. Published ea1d76e4fde787777da882be66948218f1a7ee0e exactly matches local189eb136 tree. Task1 pure hold is independently approved and all applicable CI passed (OPS35932621631, full6007/373). Production integration is not yet complete.

Sealed-source checkpoint at local993367eaabdbe7271f5bf4fa61c8e56618090e04 is independently SPEC/QUALITY approved after fixround1: exact supported C grammar, shared neutral decoder and separate unchanged closure policy. Finalfocused273/16, all3types/lint and integrity608/512 PASS; prior full6038/374 remains actual evidence before SQL/native refactor. Native204 expected NOT EXECUTED; generated types/schema pending genuine CI. Source-only capture does not complete wholeTask2 or Task3/4. Bare C DTM93 cannot establish oldStop, so unknown boundary holds matching interval. Next API publication parent remains ea1d76e4; preserve local history and compare exact tree before sync.

Task2b reference-only document design independently approved (document-reference-design/review-20260924.md); prepared brief is not dispatched. It creates no new PDF copy, preserves unresolved attempts before bounded 2MiB readback and grants no positive correction cause. New copied-artifact retention/positive C evidence remains unresolved. Task3 process-history design PH1–4 is approved for a bounded partial phase; third-set completeness requires actual native producer proof; Task4 single-MVCC/saved-cutoff actual UTILTS integration follows. None of these pending tasks is complete.

Next: publish exact reviewed tree and execute genuine disposable native CI; reconcile only authentic generated artifacts. Then sequentially implement approved document-reference and process/history/composition tasks. User approval for continuation/publication/CI/gated merge persists. Full E035 remains PARTIAL. No hosted writes, deployment or real market sends.
