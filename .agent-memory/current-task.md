# PR372 correction capture — reviewed native fixture repair

Published18debd5c57a00bbe26893d8535c75d369bb7df96 (tree5f3409166c) contains independently reviewed source capture. OPS35935812643 genuine native204 ran195PASS/9FAIL, all9 in new seed before capture due ambiguous canonical Z05 profile lookup. Native107432473768 artifact10783390496. Quality107432473782 passed actual full6038/374 and build; tenant/browser/Ediel passed. Verify/fullE2E fail only expected generated-types migration tail. Native acceptance is not granted.

Fixround2 localb274585a3ff28a4b5c1e28b8ff09e2c31b0ab759 is independently SPEC/QUALITY approved: fixture selects the real enabled C profile and all6 registry fields, preserving receipt time and guards. No production or published SQL edit. Focused71/4, scripts types/lintPASS. Parent publishes exact corrected tree, reruns native204, then reconciles authentic types/schema. Original local capture history preserved at backup/e035-local-c07c92df. New published SQL is immutable; further SQL fixes need forward migrations.

Task2 is only sealed-source capture. Task2b document-reference design and bounded streaming preflight are saved but implementation pending. Task3 bounded partial history design and exact minimum producer inventory are reviewed; actual third-set coverage still pending. Task4 conditional correction-scope/single-MVCC UTILTS composition pending. New epoch alone cannot hold unrelated supplies. Full E035 remains PARTIAL; no positive C/basis/reopening authority. PR371 remains accepted merged2a148d39; PR310 excluded.

Next: publish reviewed fixture correction to existing draft PR372, inspect genuine native result/artifacts, resolve actual failures before next sequential task. User continuation/publication/CI/gated-merge approval persists. No hosted writes/deployment/market sends.
