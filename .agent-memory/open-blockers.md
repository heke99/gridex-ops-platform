...
1. Deploy the updated OPS source including materialized OpenAPI `2026-08-05.2`.
...
4. Synchronize the tenant website against OpenAPI `2026-08-05.2` so it renders
