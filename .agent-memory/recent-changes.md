...
- 2026-08-05T22:40:00Z: Completed unfinished OpenAPI `2026-08-05.2` materialization, quote `offer` example, developer version binding and `market_data_timestamp` hash canonicalization.
