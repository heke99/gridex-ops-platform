...
describe('PR326 review: legacy builder separates legal and transport identities', () => {
  const base = { dependentConditionFacts:{endUserAddressObjects:[selectedAddressFact(point,'tenant-A','9','User-1')]}, companyId: 'tenant-A', role: 'supplier', businessCode: 'Z03', sender: { edielId: 'TECH-S' }, receiver: { edielId: 'TECH-R' },
