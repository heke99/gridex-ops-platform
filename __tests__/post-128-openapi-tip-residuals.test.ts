...
describe('post-#128 OpenAPI tip residuals', () => {
  ...
  it('uses the verified publication instant for contract release 2026-08-19.1', () => {
    expect(WEBSITE_INTEGRATION_CONTRACT_VERSION).toBe('2026-08-19.1')
