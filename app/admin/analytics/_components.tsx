...
import type { DeviationRow, ForecastSummaryRow, MetricCard, MonthlyMetricRow, ReportDefinition } from '@/lib/analytics/types'
...
export function AnalyticsFilters({
  ...
  return (
    <form className="grid gap-3 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-5">
      ...
      <label className="text-sm font-bold text-slate-700">
        SE-område
        <select name="biddingZoneCode" className="mt-1 w-full rounded-2xl border border-slate-200 px-3 py-2" defaultValue="">
      ...
      <label className="text-sm font-bold text-slate-700">
        Nätägare
        <select name="gridOwnerId" className="mt-1 w-full rounded-2xl border border-slate-200 px-3 py-2" defaultValue="">
          <option value="">Alla</option>
      ...
      <label className="text-sm font-bold text-slate-700">
        Kundtyp
        <select name="customerType" className="mt-1 w-full rounded-2xl border border-slate-200 px-3 py-2" defaultValue="">
          <option value="">Alla</option>
