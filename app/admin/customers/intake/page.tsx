...
export default async function CustomerIntakePage() {
 ...
 <h2 className="mt-2 text-xl font-semibold text-slate-950 ">{companyScope.companyName ?? 'Bolagskoppling saknas'}</h2>
 ...
 {companyScope.message ? <p className="mt-3 text-sm font-semibold text-amber-700 ">{companyScope.message}</p> : null}
 </section>
