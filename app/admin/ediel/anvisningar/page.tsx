...
export default async function AdminEdielAnvisningarPage() {
 ...
 <p className="text-sm text-slate-700">Totalt mappade regler</p>
 ...
 <div className="text-slate-700">Totalt</div>
 <div className="text-lg font-semibold text-slate-950">{group.total}</div>
 </div>

 <div className="rounded-xl bg-white/70 p-2">
 <div className="text-slate-700">Klara</div>
 ...
 <div className="rounded-xl bg-white/70 p-2">
 <div className="text-slate-700">Delvis</div>
 <div className="text-lg font-semibold text-amber-800">{group.partial}</div>
 </div>

 <div className="rounded-xl bg-white/70 p-2">
 <div className="text-slate-700">Senare</div>
 <div className="text-lg font-semibold text-emerald-800">
