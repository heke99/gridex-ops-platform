...
export default async function AdminEdielSettingsPage() {
 ...
 <h2 className="text-lg font-semibold text-slate-950">Bolagets Ediel-profil</h2>
 <p className="mt-1 text-sm text-slate-700">Du ser bara ditt bolags aktörskort och transportinställningar. Globala Ediel-regler och versioner hanteras av platform admin.</p>
 </section>
 )}
