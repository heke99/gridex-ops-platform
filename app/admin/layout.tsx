...
export default async function AdminLayout({
 ...
 const companyScope = admin.isPlatformAdmin
 ? { companyName: null }
 : await getOperationalCompanyScope(admin.userId)
 ...
 <AdminSidebar permissions={admin.permissions} roles={admin.roles} companyName={companyScope.companyName} />
 </div>
 ...
 <p>{admin.isPlatformAdmin ? 'Gridex Energy Operations • Plattformsvy' : `Gridex Energy Operations • ${companyScope.companyName ?? 'Bolagsvy'}`}</p>
