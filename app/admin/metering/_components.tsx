  ...
  return (
    <section className="grid gap-4 md:grid-cols-3 xl:grid-cols-6">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-5">
        <div className="text-sm font-medium text-slate-500">Kopplade värden</div>
              ...
              <div className="mt-4 grid gap-3 lg:grid-cols-[auto_minmax(0,1fr)]">
                <form action={prepareUtiltsE73Action}>
                  ...
                  <button
                    ...
                    className="w-full rounded-2xl bg-slate-950 px-4 py-2.5 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Förbered UTILTS E73
                  </button>
                </form>
        ...
        <table className="min-w-full text-sm">
          <thead className="bg-slate-50">
            <tr className="border-b border-slate-200 text-left">
              ...
              <th className="px-6 py-4 font-semibold text-slate-600">Typ/source</th>
