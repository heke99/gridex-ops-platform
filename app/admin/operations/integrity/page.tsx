...
function BulkActionButton({
 ...
 : variant === 'neutral'
 ? 'rounded-2xl border border-slate-300 px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 '
 : 'rounded-2xl bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-emerald-800 '
...
function FeedbackBanner({
 ...
 <span className="rounded-full border border-emerald-300 px-3 py-1 text-emerald-900 ">
 Skapade: {created}
 </span>
 ) : null}
 ...
 className="rounded-2xl border border-emerald-300 px-4 py-2.5 text-sm font-semibold text-emerald-900 hover:bg-emerald-100 "
 >
 Öppna operations
 </Link>
 </div>
 ...
 return (
 <section className="rounded-3xl border border-red-200 bg-red-50 px-6 py-5 shadow-sm ">
 <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
 <div>
 ...
 <Link
 href="/admin/billing"
 className="rounded-2xl border border-red-300 px-4 py-2.5 text-sm font-semibold text-red-900 hover:bg-red-100 "
 >
 Öppna billing
 </Link>
 <Link
...
function ActionStrip({
 ...
 className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm font-semibold text-slate-900 transition hover:bg-slate-100 "
 >
 Blockerade switchar
 </Link>
 ...
 className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-4 text-sm font-semibold text-amber-900 transition hover:bg-amber-100 "
 >
 Saknade mätvärden
 </Link>
 ...
 className="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm font-semibold text-emerald-900 transition hover:bg-emerald-100 "
 >
 Partner exports
 </Link>
...
function QueueSection({
 ...
 <Link
 href={row.detailHref}
 className="inline-flex items-center rounded-2xl border border-emerald-300 px-4 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-50 "
 >
 {row.detailLabel}
 </Link>
 ) : null}
 ...
 className="inline-flex items-center rounded-2xl bg-emerald-700 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-800 "
 >
 {row.workspaceLabel}
 </Link>
 ...
 className="inline-flex items-center rounded-2xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 "
 >
 Öppna kund
 </Link>
 </div>
