...
function SwitchEventItem({ event }: { event: SupplierSwitchEventRow }) {
 ...
 <span className="rounded-full border border-slate-200 px-3 py-1 text-xs font-semibold text-slate-700 transition group-open:bg-slate-50 ">
 Visa detaljer
 </span>
 </summary>
 ...
 />
 <button className="rounded-full border border-slate-200 px-4 py-2 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 ">
 Arkivera händelse
 </button>
 </form>
 </div>
...
export default async function AdminOperationsPage() {
 ...
 {alerts.length === 0 ? (
 <div className="rounded-2xl border border-dashed border-slate-200 p-5 text-sm text-slate-700 ">
 ...
 <td
 colSpan={4}
 className="px-6 py-8 text-sm text-slate-700 "
 >
