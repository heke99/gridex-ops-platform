                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-4">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {recommendedPermissions.length > 0 ? (
                        ...
                        <span className="text-sm text-slate-500">Ingen definierad profil.</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-4">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {missingFromDb.length > 0 ? (
                        ...
                        <span className="text-sm text-slate-500">Inget saknas.</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-4">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {extraInDb.length > 0 ? (
                        ...
                        <span className="text-sm text-slate-500">Inga extra permissions.</span>
                      )}
                    </div>
                  </div>
                </div>
