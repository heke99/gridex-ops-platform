    ...
    <div className="space-y-8 p-8">
      <div className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-500">{user.authUser.id}</p>
      ...
      <section className="grid gap-4 xl:grid-cols-4">
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <p className="text-sm font-medium text-slate-500">Aktiva roller</p>
          <p className="mt-2 text-3xl font-semibold text-slate-950">{activeRoleCount}</p>
        </div>
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <p className="text-sm font-medium text-slate-500">Overrides</p>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 space-y-3">
          {user.roles.length === 0 && (
            <p className="text-sm text-slate-500">Inga aktiva roller.</p>
          )}
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 space-y-3">
          {user.overrides.length === 0 && (
            <p className="text-sm text-slate-500">Inga overrides.</p>
          )}
