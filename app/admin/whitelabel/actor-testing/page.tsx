...
export default async function WhiteLabelActorTestingPage() {
  ...
  return (
    <div className="min-h-screen">
      <AdminHeader title="Aktörstester" subtitle="White-label-vy. Här visas bara bolag inom din egen white-label-plattform." userEmail={admin.email} workspaceName="Min plattform" />
