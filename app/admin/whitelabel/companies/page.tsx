...
export default async function WhiteLabelCompaniesPage() {
  ...
  return (
    <div className="min-h-screen">
      <AdminHeader title="Mina bolag" subtitle="Endast bolag som tillhör din white-label-plattform visas här." userEmail={admin.email} workspaceName="Min plattform" />
