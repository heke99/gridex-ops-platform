...
import { externalCustomerIdFromRequest, resolvePortalCustomerContext, listPortalInvoices } from '@/lib/customer-portal/apiData'
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await listPortalInvoices(context, request.nextUrl.pathname)
