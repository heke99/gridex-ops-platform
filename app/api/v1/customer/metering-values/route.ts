...
import { externalCustomerIdFromRequest, resolvePortalCustomerContext, listPortalMeteringValues } from '@/lib/customer-portal/apiData'
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await listPortalMeteringValues(context, request.nextUrl.pathname)
