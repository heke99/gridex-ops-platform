...
import { externalCustomerIdFromRequest, resolvePortalCustomerContext, listPortalSites } from '@/lib/customer-portal/apiData'
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await listPortalSites(context, request.nextUrl.pathname)
