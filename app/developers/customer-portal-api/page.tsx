...
import publicContractsFixture from "@/docs/fixtures/public-contracts-response-2026-08-14.1.json";
...

{
  ...
  "contract_schema_version": "2026-08-14.1"
}`;
...
// Statusnamnet avgör inte readiness. Ett säkert postal consensus kan vara pricing_ready, men aldrig EDIFACT-ready.
      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <Section id="customer-applications" title="5. Skicka kundansökan">
          <p>
            ...
            Anonyma kundansökningar stöds inte i kontraktsversion 2026-08-14.1.
