    ...
    <div className="space-y-6">
      <section className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-6 text-slate-600">
          När kopplingen är godkänd hämtas dina fakturor, anläggningar och din
          förbrukning till kundportalen på gridex.se. Fakturor visas enligt C1-modellen:
          först när fakturapartnern har skapat fakturan och skickat tillbaka fakturadata/PDF.
        </p>
        <div className="mt-5">
