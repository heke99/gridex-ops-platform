...
aperak_status: normalizeRecommendationAckStatus(
 ...
 className="rounded-2xl border border-emerald-300 px-4 py-2 text-sm font-medium text-emerald-700 "
 >
 Ediel-routes
 </Link>
 </div>
 ...
 <span className={`rounded-full px-2 py-1 text-xs font-semibold ${recommendation.routeHealth.hasTargetEmail ? 'bg-emerald-100 text-emerald-700 ' : 'bg-amber-100 text-amber-700 '}`}>
 target email {recommendation.routeHealth.hasTargetEmail ? 'ok' : 'saknas'}
 </span>
 <span className={`rounded-full px-2 py-1 text-xs font-semibold ${recommendation.routeHealth.hasSenderEdielId ? 'bg-emerald-100 text-emerald-700 ' : 'bg-red-100 text-red-700 '}`}>
 sender {recommendation.routeHealth.hasSenderEdielId ? 'ok' : 'saknas'}
 </span>
 <span className={`rounded-full px-2 py-1 text-xs font-semibold ${recommendation.routeHealth.hasReceiverEdielId ? 'bg-emerald-100 text-emerald-700 ' : 'bg-red-100 text-red-700 '}`}>
 receiver {recommendation.routeHealth.hasReceiverEdielId ? 'ok' : 'saknas'}
 </span>
 <span className={`rounded-full px-2 py-1 text-xs font-semibold ${recommendation.routeHealth.hasMailbox ? 'bg-emerald-100 text-emerald-700 ' : 'bg-red-100 text-red-700 '}`}>
 ...
 <button
 className="mt-4 w-full rounded-2xl bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white disabled:opacity-50"
 ...
 <button
 className="mt-4 w-full rounded-2xl border border-slate-300 px-4 py-2.5 text-sm font-semibold text-slate-700 disabled:opacity-50 "
 disabled={blockingIssues}
 >
 Skapa Z09-utkast
 </button>
 ...
 <button
 className="w-full rounded-2xl bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white disabled:opacity-50"
 ...
 className="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 underline-offset-2 hover:underline "
 >
...
function EdielLifecyclePanel({
 ...
 {!hasAnySignal ? (
 <div className="mt-4 rounded-2xl border border-dashed border-slate-300 px-4 py-4 text-sm text-slate-700 ">
...
function LifecycleCard({
 ...
 <div className="mt-1 text-sm text-slate-700 ">{emptyLabel}</div>
 </div>
 )
 }
 ...
 <Link
 href={`/admin/ediel/messages/${message.id}`}
 className="rounded-full bg-slate-100 px-3 py-1 text-xs text-slate-700 underline-offset-2 hover:underline "
 >
 {message.message_family} {message.message_code}
 </Link>
 {ackBadges.map((badge) => (
