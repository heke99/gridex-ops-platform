  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      ...
      <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
        Skapar kund, kontaktperson, anläggning, eventuell mätpunkt och kundavtal i ett sammanhållet flöde.
      </p>
      ...
      <form action={formAction} className="mt-6 space-y-6" data-customer-intake-form>
        ...
        <div>
          ...
          <div className="mt-3 grid gap-4 md:grid-cols-2">
            ...
            <label className="grid gap-1 text-sm md:col-span-2">
              <span className="text-slate-600 dark:text-slate-300">Orsak till kundspecifik justering</span>
              <input name="overrideReason" placeholder="Orsak till kundspecifik justering" className={inputClassName(state, 'overrideReason', 'full')} />
            ...
            <div className="grid gap-1 text-sm">
              <input name="greenFeeValue" placeholder="Kundspecifikt värde för grön el" className={inputClassName(state, 'greenFeeValue')} />
