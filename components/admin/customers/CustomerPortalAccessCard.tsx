      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          ...
          <Link
            ...
            className="rounded-2xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200"
          >
            Partnerfakturor
          </Link>
        </div>
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-3">
          <div className="rounded-2xl bg-slate-50 px-4 py-3 text-sm dark:bg-slate-950">
            <div className="text-slate-500 dark:text-slate-400">Aktiva portal-konton</div>
            <div className="mt-1 text-2xl font-semibold text-slate-950 dark:text-white">
              {activeAccounts.length}
            </div>
          </div>
          <div className="rounded-2xl bg-slate-50 px-4 py-3 text-sm dark:bg-slate-950">
            <div className="text-slate-500 dark:text-slate-400">Totala claims</div>
            <div className="mt-1 text-2xl font-semibold text-slate-950 dark:text-white">
              {claims.length}
            </div>
          </div>
          <div className="rounded-2xl bg-slate-50 px-4 py-3 text-sm dark:bg-slate-950">
            <div className="text-slate-500 dark:text-slate-400">Senaste claim</div>
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              {accounts.map((account) => (
                <article key={account.id} className="p-5">
                  ...
                  <div className="mt-4 rounded-2xl bg-slate-50 p-3 text-xs text-slate-600 dark:bg-slate-950 dark:text-slate-300">
