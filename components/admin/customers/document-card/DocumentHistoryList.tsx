...
export default function DocumentHistoryList({
 ...
 <div className="rounded-2xl bg-slate-100 px-3 py-1 text-xs font-medium text-slate-700 ">
 ...
 <div className="rounded-2xl border border-dashed border-slate-300 px-4 py-8 text-sm text-slate-700 ">
 ...
 key={`${item.id}:${index}`}
 href={link.href}
 className="inline-flex items-center rounded-2xl bg-slate-100 px-3 py-2 text-xs font-medium text-slate-700 hover:bg-slate-200 "
 >
 {link.label}
 </Link>
 )
 ...
 className="inline-flex items-center rounded-2xl bg-emerald-50 px-3 py-2 text-xs font-medium text-emerald-700 hover:bg-emerald-100 "
 >
 ...
 className="inline-flex items-center rounded-2xl bg-amber-50 px-3 py-2 text-xs font-medium text-amber-700 hover:bg-amber-100 "
 >
 ...
 className="block rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs transition hover:bg-slate-50 "
 >
 <div className="font-medium text-slate-900 ">
 {row.request_scope}
 </div>
