...
function CaseCard({
 ...
 {candidates.length === 0 ? (
 <p className="mt-2 text-sm text-slate-700">Ingen matchande inbound hittad ännu.</p>
 ) : (
 ...
 <span className="text-slate-700">{formatDateTime(message.created_at)}</span>
 </div>
...
export default function EdielAgtWorkbenchPanel({
 ...
 <div className="text-xs font-semibold uppercase tracking-wide text-slate-700">PRODAT</div>
 <div className="mt-1 text-sm text-slate-900">L1, L2, L3, L4, L5, L7</div>
 </div>
 <div className="rounded-2xl bg-white p-3">
 <div className="text-xs font-semibold uppercase tracking-wide text-slate-700">UTILTS</div>
 <div className="mt-1 text-sm text-slate-900">UL1, UL2, UL3, UL4, UL6</div>
 </div>
 <div className="rounded-2xl bg-white p-3">
 <div className="text-xs font-semibold uppercase tracking-wide text-slate-700">Aktiva AGT-runs</div>
 ...
 <span className="text-sm text-slate-700">L1 och L7 genereras och skickas direkt. L2-L5 besvarar portalens inbound.</span>
 </div>
 ...
 <span className="text-sm text-slate-700">Inbound från portalen ska få positiv CONTRL och negativ UTILTS/UTILTS_ERR.</span>
 </div>
 <div className="grid gap-4 xl:grid-cols-2">
