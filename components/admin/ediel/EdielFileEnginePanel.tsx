...
export default function EdielFileEnginePanel({
 ...
 className="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-950 placeholder:text-slate-500"
 />
 <p className="mt-1 text-xs text-slate-700">Används bara i motorläge AGT när flera inbound-meddelanden har samma kod, exempelvis E66 för UL2/UL3.</p>
 </label>
 </div>
 ...
 <div className="mt-1 text-xs text-slate-700">{template.focus}</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <span className="text-xs text-slate-700">Visar transport_type = manual_upload</span>
 </div>
 ...
 <tr>
 <td colSpan={6} className="px-3 py-5 text-center text-slate-700">
 ...
 <td className="px-3 py-2 text-xs text-slate-700">{formatDateTime(row.created_at)}</td>
