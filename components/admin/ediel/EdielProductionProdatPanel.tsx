...
function FormSection({
 ...
 {description ? <p className="mt-1 text-[11px] text-slate-700">{description}</p> : null}
...
function PortalTestCatalogPanel() {
 ...
 <p className="mt-3 text-xs text-slate-700">{group.description}</p>
 </div>
 ...
 <p className="mt-1 text-xs text-slate-700">{testCase.testDataHint}</p>
