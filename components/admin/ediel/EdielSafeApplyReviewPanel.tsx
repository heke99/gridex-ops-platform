...
function ChangeTable({ item }: { item: EdielSafeApplyReviewItem }) {
 ...
 return <div className="rounded-xl border border-dashed border-slate-300 p-3 text-sm text-slate-700">Inga föreslagna ändringar.</div>
 }
 ...
 <div className="max-w-[180px] truncate text-xs text-slate-700">{change.entityId}</div>
 </td>
 <td className="px-3 py-2 font-medium text-slate-900">{change.label}</td>
 <td className="px-3 py-2 text-slate-700">{valueText(change.currentValue)}</td>
...
export default function EdielSafeApplyReviewPanel({
 ...
 <div className="rounded-2xl border border-dashed border-slate-300 p-5 text-sm text-slate-700">
