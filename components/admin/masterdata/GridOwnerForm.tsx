    ...
    >
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-700 ">
          Lägg in eller uppdatera nätägare med kod, EDIEL-id och
          kontaktuppgifter.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        />
        <label className="grid gap-2">
          <span className="text-sm font-medium text-slate-700 ">Miljö</span>
          <select
            name="environment"
            defaultValue={gridOwner?.environment ?? "production"}
            className="h-11 rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none transition focus:border-slate-400 "
          >
        ...
        <label className="grid gap-2">
          ...
          <select
            ...
            defaultValue={gridOwner?.lifecycle_status ?? "active"}
            className="h-11 rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none transition focus:border-slate-400 "
          >
            <option value="draft">Utkast</option>
            <option value="verified">Verifierad</option>
            <option value="active">Aktiv</option>
            <option value="deprecated">Avvecklad</option>
            <option value="blocked">Spärrad</option>
          </select>
        </label>
        <Input
          name="default_prodat_subaddress"
          label="PRODAT subaddress"
          defaultValue={gridOwner?.default_prodat_subaddress}
        />
        <Input
          name="default_utilts_subaddress"
          label="UTILTS subaddress"
          defaultValue={gridOwner?.default_utilts_subaddress}
        />
        <Input
          name="transport_channel"
          label="Transportkanal"
          defaultValue={gridOwner?.transport_channel}
        />
        <Input
          name="communication_email"
          label="Ediel/kommunikationsmail"
          type="email"
          defaultValue={gridOwner?.communication_email}
        />
        <Input
          name="contact_name"
          label="Kontaktperson"
        ...
        />
        <Input name="phone" label="Telefon" defaultValue={gridOwner?.phone} />
        <Input
          name="country"
          label="Land"
        ...
        />
        <Input name="city" label="Ort" defaultValue={gridOwner?.city} />
      </div>
      ...
      <label className="mt-4 inline-flex items-center gap-3">
        ...
        />
        <span className="text-sm text-slate-700 ">Aktiv nätägare</span>
      </label>
