...
- `GET /api/public/energy-area?postal_code=` — removed before API 2026-07-28.1 and remains unavailable; returns `410 Gone`
...
## 11. Canonical fastpris, quote och kundkedja (`2026-07-28.1`)
