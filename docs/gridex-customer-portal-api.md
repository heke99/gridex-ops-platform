...
Dokumentationsversion: `2026-07-30.1`.
...
API-svaret innehåller `contract_schema_version=2026-07-30.1` och headern `X-Gridex-Contract-Version`. Versionsvärdet ingår i ETag-underlaget så att klienter inte får `304 Not Modified` mot en äldre DTO när kontraktsrepresentationen ändras.

## Avgränsning mot Website Integration API 2026-07-30.1
...
## Extern kontraktsändring 2026-07-30.1
