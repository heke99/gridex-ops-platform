...
for (const token of ['normalized_metering_values', 'customer_supply_periods', 'validateIntervalCoverage', 'gridex_store_billing_underlay']) {
...
for (const token of ['provider_invoice_guid', 'idempotencyKey', 'assertOutboundAllowed', 'withAutomationLock']) {
