...
export const ADMIN_PAGE_ACCESS: Record<AdminPageKey, PermissionRequirement> = {
  ...
  'company.actor_status': { anyOf: ['communication.read', 'users.read', 'customers.read', 'billing_underlay.read', 'partner_exports.read'] },
  ...
  'platform.ediel.runtime': { allOf: ['tenants.write', 'roles.manage', 'permissions.manage'] },
  'operations.control_tower': {
    anyOf: [
      'switching.read',
      'metering.read',
