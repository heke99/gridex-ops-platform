...
const PLATFORM_NAVIGATION: AdminNavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'ediel.system_tests', label: 'Systemtest', href: '/admin/ediel/system-tests', description: 'Rulebook, testfall, parser och regression', pageKey: 'platform.ediel.rules', platformOnly: true },
      { key: 'ediel.rule_center', label: 'Regelcenter', href: '/admin/ediel/system-tests?tab=versions', description: 'Regelversioner, fältmatris och ACK-regler', pageKey: 'platform.ediel.rules', platformOnly: true },
      { key: 'ediel.ai_list', label: 'AI-lista', href: '/admin/ediel/system-tests?tab=ai', description: 'AI/BI-regler och avvikelsekontroll', pageKey: 'platform.ediel.rules', platformOnly: true },
