...
const PLATFORM_NAVIGATION: AdminNavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'ediel.invoice_test', label: 'Fakturatest', href: '/admin/ediel/test-center/invoice-test', description: 'EDIFACT till mätvärden, billing, faktura och Capway/Aptic TEST', pageKey: 'platform.actor_testing', platformOnly: true },
