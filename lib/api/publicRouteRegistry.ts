...
export const PUBLIC_API_ROUTES: PublicApiRouteContract[] = [
  ...
  { method: 'POST', path: '/api/v1/website/quote', scopes: [], description: 'Borttagen i API 2026-07-22.2. Returnerar 410; tenantens backend beräknar indikativa marknadspriser.', rateLimitClass: 'read' },
  { method: 'POST', path: '/api/v1/website/quote/validate', scopes: [], description: 'Borttagen i API 2026-07-22.2. Returnerar 410; quote_reference används inte i nya ansökningar.', rateLimitClass: 'read' },
  { method: 'POST', path: '/api/v1/website/energy-area/resolve', scopes: [], description: 'Borttagen i API 2026-07-22.2. Returnerar 410; tenantens webbplats löser prisområdet själv.', rateLimitClass: 'read' },
