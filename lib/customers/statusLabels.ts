...
export function intakeStatusLabel(value: string | null | undefined): string {
  switch (String(value ?? '').toLowerCase()) {
    ...
    case 'needs_completion': return 'Behöver kompletteras'
    case 'pending_information': return 'Väntar på uppgifter'
    case 'pending_power_of_attorney': return 'Väntar på fullmakt'
    case 'pending_duplicate_review': return 'Möjlig dubblett – kräver granskning'
    case 'blocked': return 'Blockerad'
    case 'ready_for_contract': return 'Redo för avtal'
    case 'ready_for_operations': return 'Redo för drift'
    case 'needs_contract_or_poa': return 'Avtal eller fullmakt saknas'
    case 'needs_grid_owner_resolution': return 'Nätägare behöver verifieras'
    case 'needs_facility_lookup': return 'Anläggningsuppgifter behöver hämtas'
    case 'facility_lookup_ready_to_send': return 'Redo att fråga nätägaren'
    case 'facility_lookup_waiting_response': return 'Väntar på nätägare'
    case 'ready_for_supplier_switch': return 'Redo för leverantörsbyte'
    case 'supplier_switch_waiting_response': return 'Leverantörsbyte pågår'
    case 'active_supply': return 'Aktiv leverans'
    case 'needs_admin_review': return 'Kräver handläggning'
