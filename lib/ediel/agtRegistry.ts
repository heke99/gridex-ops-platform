...
export const EDIEL_AGT_SUPPLIER_2026A_CASES: EdielAgtTestCaseDefinition[] = [
  ...
  }),
  {
    ...
    notes: [
      ...
      'L7 ska använda transaktionstyp 223 = E32 och mätmetod 217 = Z04 enligt portalens testdata för L7.',
