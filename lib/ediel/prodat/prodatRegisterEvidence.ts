...
export type ProdatRegisterEvidence = {
  ...
  bodyBinding: string
  facts: Pick<ProdatDependentConditionFacts, 'market' | 'meterReadingsSentInUtilts' | 'registerObjects' | 'endUserAddressObjects' | 'invoiceeObjects' | 'dateEventObjects' | 'dateEventSource' | 'meterChange' | 'deathStatus'> & {reportingPermission?:TgtEvidence|Omit<PureSelection,'evaluationUtcMs'>|null}
}
