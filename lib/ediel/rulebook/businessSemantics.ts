...
const PRODAT_DEFINITIONS: Record<string, ProdatDefinition> = {
  ...
  'Z06:E':  { officialMeaning: 'Grid-owner death notification or bilateral customer masterdata update; bankruptcy alone does not establish death.', businessProcess: 'customer_masterdata_update_grid_to_supplier', operationKind: 'notification', domainObject: 'customer_masterdata', businessEffect: 'update_customer_masterdata', expectedBusinessResponses: none, historical: false, requestsData: false, bilateralPolicy: 'contextual', requiresCustomerStatus: true, autoStateMutationAllowed: false },
  ...
  'Z09:E':  { officialMeaning: 'Supplier death notification only; own Z09E establishes the death process (PRODAT p112).', businessProcess: 'customer_masterdata_update_supplier_to_grid', operationKind: 'notification', domainObject: 'customer_masterdata', businessEffect: 'update_customer_masterdata', expectedBusinessResponses: ['PRODAT:Z06:E'], historical: false, requestsData: false, bilateralPolicy: 'none', requiresCustomerStatus: true, autoStateMutationAllowed: false },
