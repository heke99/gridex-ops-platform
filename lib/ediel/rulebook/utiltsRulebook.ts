...
export const UTILTS_CANONICAL_PROFILES: readonly UtiltsCanonicalProfile[] = [
  ...
  profile({ profileKey: 'utilts_s06', messageCode: 'S06', phase: 'settlement', allowedSenderRoles: UTILTS_MARKET_ROLES, allowedReceiverRoles: UTILTS_MARKET_ROLES, bilateralCapabilityRequired: true, scope: 'meter_change', requiredSignals: [...common, 'IDE', 'LOC'], requiresTransaction: true, requiresMeteringPoint: true, requiresGridArea: false, requiresPeriod: true, requiresResolution: false, requiresUnit: true, requiresQuantities: true, supportsCorrections: true, validatesDst: false, agtCases: [] }),
