...
export type EdielAgtExpectedResponse =
  | "positive_contrl"
  | "negative_aperak"
  | "negative_utilts"
  | "inbound_aperak";
...
function actorOutbound(
  stepNo: number,
  family: EdielMessageFamily,
  code: string,
  title: string,
): EdielAgtExpectedStep {
  return { stepNo, actor: "actor", direction: "outbound", family, code, title };
}

function portalInbound(
  stepNo: number,
  family: EdielMessageFamily,
  code: string,
  title: string,
  ...
  return {
    ...
    expectedSteps: [
      portalInbound(
        ...
        "PRODAT",
        params.messageCode,
        `Edielportalen skickar ${params.messageCode}`,
      ),
  ...
  return {
    ...
    expectedSteps: [
      portalInbound(
        ...
        "UTILTS",
        params.messageCode,
        `Edielportalen skickar ${params.messageCode}${params.messageVariant ? ` ${params.messageVariant}` : ""}`,
      ),
      actorOutbound(2, "CONTRL", "CONTRL", "Positiv CONTRL till Edielportalen"),
      actorOutbound(
        3,
        "UTILTS_ERR",
        "UTILTS_ERR",
        "Negativ UTILTS/UTILTS_ERR till Edielportalen",
      ),
      portalInbound(
        4,
        "APERAK",
        "APERAK",
        "Edielportalen skickar APERAK på negativ UTILTS",
      ),
    ],
  };
}
...
export const EDIEL_AGT_SUPPLIER_2026A_CASES: EdielAgtTestCaseDefinition[] = [
  {
    ...
    purpose:
      "Verifierar att leverantören kan skicka PRODAT Z03 till Edielportalen och ta emot positiv CONTRL samt negativ APERAK.",
    agtInstruction:
      "Starta L1 i Edielportalen. Skicka därefter outbound Z03 direkt från GridCore. Leverantörens Ediel-id och eventuell sender-subadress ska komma från aktiv tenant/Edielregistret, mottagare är 91100:ZZ:PRODAT. Efter skick inväntas CONTRL + APERAK från portalen.",
    notes: [
    ...
    expectedSteps: [
      ...
      portalInbound(
        ...
        "CONTRL",
        "CONTRL",
        "Edielportalen skickar positiv CONTRL om begärd",
      ),
      portalInbound(
        3,
        "APERAK",
        "APERAK",
        "Edielportalen skickar negativ APERAK",
      ),
    ],
  },
  prodatPortalToActor({
    ...
    title: "PRODAT L2 · Z04",
    purpose:
      "Verifierar att leverantören kan ta emot PRODAT Z04, skicka positiv CONTRL och negativ APERAK.",
    instruction:
      "Starta L2 i Edielportalen. Vänta på inbound Z04 från portalen, importera filen med motorläge AGT och skapa AGT-svar från inbound-raden.",
  }),
  prodatPortalToActor({
    testCaseCode: "L3",
    messageCode: "Z05",
    title: "PRODAT L3 · Z05",
    purpose:
      "Verifierar att leverantören kan ta emot PRODAT Z05, skicka positiv CONTRL och negativ APERAK.",
    instruction:
      "Starta L3 i Edielportalen. Vänta på inbound Z05 från portalen, importera filen med motorläge AGT och skapa AGT-svar från inbound-raden.",
  }),
  prodatPortalToActor({
    testCaseCode: "L4",
    messageCode: "Z06",
    title: "PRODAT L4 · Z06",
    purpose:
      "Verifierar att leverantören kan ta emot PRODAT Z06, skicka positiv CONTRL och negativ APERAK.",
    instruction:
      "Starta L4 i Edielportalen. Vänta på inbound Z06 från portalen, importera filen med motorläge AGT och skapa AGT-svar från inbound-raden.",
  }),
  prodatPortalToActor({
    testCaseCode: "L5",
    messageCode: "Z10",
    title: "PRODAT L5 · Z10",
    purpose:
      "Verifierar att leverantören kan ta emot PRODAT Z10, skicka positiv CONTRL och negativ APERAK.",
    instruction:
      "Starta L5 i Edielportalen. Vänta på inbound Z10 från portalen, importera filen med motorläge AGT och skapa AGT-svar från inbound-raden.",
  }),
  {
    suite: "PRODAT",
    roleCode: "supplier",
    ...
    purpose:
      "Verifierar att leverantören kan skicka PRODAT Z09F/Z09G till Edielportalen och ta emot positiv CONTRL samt negativ APERAK.",
    agtInstruction:
      "Starta L7 i Edielportalen. Skicka därefter outbound Z09 direkt från GridCore. Leverantörens Ediel-id och eventuell sender-subadress ska komma från aktiv tenant/Edielregistret, mottagare är 91100:ZZ:PRODAT. Efter skick inväntas CONTRL + APERAK från portalen.",
    notes: [
  ...
  utiltsPortalToActor({
    ...
    purpose:
      "Verifierar att leverantören kan ta emot UTILTS S03, skicka positiv CONTRL och negativ UTILTS/UTILTS_ERR.",
    instruction:
      "Starta UL1 i Edielportalen. Vänta på inbound S03, importera filen med motorläge AGT och skapa AGT-svar från inbound-raden.",
  }),
  utiltsPortalToActor({
    testCaseCode: "UL2",
    messageCode: "E66",
    ...
    purpose:
      "Verifierar att leverantören kan ta emot UTILTS E66 med kvartsvärden, skicka positiv CONTRL och negativ UTILTS/UTILTS_ERR.",
    instruction:
      "Starta UL2 i Edielportalen. Vänta på inbound E66 KVART, importera filen med motorläge AGT och ange UL2 om systemet behöver skilja E66-fallen.",
  }),
  utiltsPortalToActor({
    testCaseCode: "UL3",
    messageCode: "E66",
    ...
    purpose:
      "Verifierar att leverantören kan ta emot UTILTS E66-SCH, skicka positiv CONTRL och negativ UTILTS/UTILTS_ERR.",
    instruction:
      "Starta UL3 i Edielportalen. Vänta på inbound E66-SCH, importera filen med motorläge AGT och ange UL3 om systemet behöver skilja E66-fallen.",
  }),
  utiltsPortalToActor({
    testCaseCode: "UL4",
    messageCode: "S02",
    ...
    purpose:
      "Verifierar att leverantören kan ta emot UTILTS S02, skicka positiv CONTRL och negativ UTILTS/UTILTS_ERR.",
    instruction:
      "Starta UL4 i Edielportalen. Vänta på inbound S02, importera filen med motorläge AGT och skapa AGT-svar från inbound-raden.",
  }),
  utiltsPortalToActor({
    testCaseCode: "UL6",
    messageCode: "E31",
    ...
    purpose:
      "Verifierar att leverantören kan ta emot UTILTS E31-SCH, skicka positiv CONTRL och negativ UTILTS/UTILTS_ERR.",
    instruction:
      "Starta UL6 i Edielportalen om den visas/krävs. Vänta på inbound E31-SCH, importera filen med motorläge AGT och skapa AGT-svar från inbound-raden.",
  }),
];
...
export function isEdielAgtRunApprovalVersion(
  ...
  const normalized = String(value ?? "")
    ...
    .toUpperCase();
  return (
    normalized === EDIEL_AGT_APPROVAL_VERSION_2026A ||
    normalized.startsWith(`${EDIEL_AGT_APPROVAL_VERSION_LABEL_2026A} `) ||
    normalized.startsWith(`${EDIEL_AGT_APPROVAL_VERSION_LABEL_2026A} ·`)
  );
}
...
export function getEdielAgtSupplier2026ACase(
  testCaseCode: string,
): EdielAgtTestCaseDefinition | null {
  const normalized = String(testCaseCode ?? "")
    .trim()
    .toUpperCase();
  return (
    EDIEL_AGT_SUPPLIER_2026A_CASES.find(
      (testCase) => testCase.testCaseCode === normalized,
    ) ?? null
  );
}
...
export function inferEdielAgtCaseForInboundMessage(params: {
  ...
  const explicit = String(params.explicitTestCaseCode ?? "")
    .trim()
    .toUpperCase();
  if (explicit)
  ...
  if (family === "UTILTS") {
    ...
    if (code === "E66") {
      if (rawContains(params.rawPayload, ["SCH"]))
        return getEdielAgtSupplier2026ACase("UL3");
      if (rawContains(params.rawPayload, ["KVART", ":15:804", ":PT15M", "15M"]))
        return getEdielAgtSupplier2026ACase("UL2");
      return null;
    }
  }
