...
/**
 * Certified system-test-only override. Production callers must use the
 * canonical plan returned by runUtiltsRuntimeForMessage without applying this
 * function. Keeping the matrix under /testing prevents test certification
 * fixtures from becoming a second production rule authority.
 */
