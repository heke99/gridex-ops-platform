...
function prodatInboundPositiveCase(
  testCaseCode: string,
  title: string,
  code: string,
  purpose: string,
...
function prodatInboundNegativeCase(
  testCaseCode: string,
  title: string,
  code: string,
  purpose: string,
...
function prodatOutboundPositiveCase(
  testCaseCode: string,
  title: string,
  code: string,
  purpose: string,
...
function utiltsNegativeAperakCase(
  testCaseCode: string,
  title: string,
  code: string,
  purpose: string,
...
function utiltsEscoPositiveCase(
  testCaseCode: string,
  title: string,
  code: string,
  purpose: string,
...
function utiltsEscoNegativeAperakCase(
  testCaseCode: string,
  title: string,
  code: string,
  purpose: string,
...
function prodatAgtEscoOutboundCase(params: {
  ...
  return {
    ...
    expectedSteps: [
      ...
      },
      {
        ...
        outcome: "positive",
        required: true,
        title: `Skicka positiv APERAK på E66-${params.subtype}`,
        description:
          "Mätvärdesmeddelandet accepteras och ska inte ge UTILTS_ERR i korrekt AGT UE-test.",
      },
    ],
    notes: [
...
function legacyEscoRegressionCase(
...
function additionalEdielTgtTestCases(): EdielTgtTestCaseDefinition[] {
  return [
    ...
    utiltsAgtEscoInboundPositiveCase({
      ...
      testDataHint:
        "UE1 är portal → aktör. Starta i Edielportalen och låt Gridex hämta inbound UTILTS via IMAP, därefter positiv CONTRL + positiv APERAK.",
    }),
    utiltsAgtEscoInboundPositiveCase({
      testCaseCode: "UE2",
      ...
      testDataHint:
        "UE2 är portal → aktör. Starta i Edielportalen och låt Gridex hämta inbound UTILTS via IMAP, därefter positiv CONTRL + positiv APERAK.",
    }),
...
export const EDIEL_TGT_TEST_CASES: readonly EdielTgtTestCaseDefinition[] = [
  {
    ...
    testDataHint:
      "Testkund 1 enligt PRODAT bilaga 1. Z03L med extra information.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
  ...
  },
  {
    ...
    testDataHint:
      "Testkund 20 enligt PRODAT bilaga 1. Z03LK/Z04LK med minsta information.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
    ...
    notes: [
      "Detta är ett bra första TGT-flöde efter att filmotorn är på plats.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    testDataHint:
      "Testkund S1 enligt Edielportalen. Z04D mikroproduktion med register 201 och 202.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        title: "Skicka PRODAT Z03",
        description:
          "Gridex skickar Z03 med kund-, anläggnings- och avtalsdata till Edielportalen.",
      },
      {
        stepNo: 2,
        direction: "inbound",
      ...
      },
      {
        ...
        code: "Z04",
        required: true,
        title: "Skicka PRODAT Z04D mikroproduktion",
        description:
          "Gridex skickar Z04D med två register, mätarnummer, produktkod, avräkningsmetod och mikroproduktionsdata.",
      },
      {
        stepNo: 5,
        direction: "inbound",
        ...
        required: true,
        title: "Ta emot positiv CONTRL",
        description: "Portalen kvitterar syntax för Z04D.",
      },
      {
        stepNo: 6,
        direction: "inbound",
  ...
  },
  {
    ...
    testDataHint:
      "Testkund 5 enligt PRODAT bilaga 1. Felaktigt anläggnings-/mätpunkts-id provoceras.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
      ...
      },
      {
        ...
        title: "Ta emot positiv CONTRL",
        description:
          "Syntaxen kan vara korrekt även om affärsinnehållet är fel.",
      },
      {
        stepNo: 3,
        direction: "inbound",
        ...
        description:
          "Portalen avvisar affärsinnehåll, till exempel okänt objekt.",
      },
    ],
    notes: [
      "Detta test ska inte skapa ny positiv APERAK för samma transaktion.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    testDataHint:
      "Manipulerad EDIFACT-fil enligt testbeskrivning för syntaxfel.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
    ...
    notes: [
      "Efter negativ CONTRL ska ärendet larmas och kunna omsändas efter korrigering.",
    ],
  },
  {
    suite: "UTILTS",
    ...
    testDataHint:
      "Testanläggning enligt UTILTS bilaga 1. E66 för enskilda värden.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "inbound",
    ...
    notes: [
      "Detta ska senare kopplas mot mätvärdesimport och kundportalens förbrukningsvy.",
    ],
  },
  {
    suite: "UTILTS",
    ...
    expectedSteps: [
      ...
      },
      {
        ...
        description:
          "Används när felet upptäcks vid kontroll/lagring, exempelvis okänd mätpunkt eller saknade värden.",
      },
    ],
    notes: [
      "I detta test är APERAK eller UTILTS-ERR beroende av feltyp; minst ett negativt svar ska hanteras.",
    ],
  },

  {
    ...
    status: "ready_for_file_engine",
    purpose:
      "Verifierar att portalen avvisar Z03LK med fel nätområdesid och att GridCore kan registrera negativ APERAK.",
    testDataHint:
      "Testkund 7. Skicka Z03LK men provocera fel nätområdesid TEX.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        code: "Z03",
        required: true,
        title: "Skicka felaktig PRODAT Z03LK",
        description: "Skickas med fel nätområdesid TEX.",
      },
      {
        stepNo: 2,
        direction: "inbound",
        ...
        required: true,
        title: "Ta emot positiv CONTRL",
        description: "Syntaxen ska vara korrekt.",
      },
      {
        stepNo: 3,
        direction: "inbound",
        ...
        title: "Ta emot negativ APERAK",
        description:
          "Förväntat fel: ERC 42, FTX-kod 260, text Felaktigt nätområdesid TEX.",
      },
    ],
    notes: [
      "Detta är ett mottagningstest av negativ APERAK. Skapa inte egen APERAK på portalens APERAK.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    testCaseCode: "1.3.3",
    title:
      "Negativ APERAK efter Z03L: fel transaktionstyp, saknad ärendereferens, fel balansansvarig",
    approvalVersion: "TGT 6.0.5 / Edielportalen 4.1",
    market: "el",
    source: "TGT_PRODAT_UTILTS_6_0_5",
    scope: "core",
    status: "ready_for_file_engine",
    purpose:
      "Verifierar negativ APERAK när flera affärsfel framprovoceras i Z03.",
    testDataHint:
      "Testkund 7. Manipulerad fil: transaktionstyp Z26, RFF+LI saknas och balansansvarig 99999.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        code: "Z03",
        required: true,
        title: "Skicka manipulerad PRODAT Z03",
        description: "Z03L med Z26, saknad RFF+LI och balansansvarig 99999.",
      },
      {
        stepNo: 2,
        direction: "inbound",
      ...
      },
      {
        ...
        title: "Ta emot negativ APERAK",
        description:
          "Minst ett av de förväntade felen ska rapporteras enligt portalen.",
      },
    ],
  ...
  },
  {
    ...
    status: "ready_for_file_engine",
    purpose:
      "Verifierar multi-anläggningsflöde där två anläggningar accepteras och en avvisas på grund av felaktigt datum.",
    testDataHint:
      "Importera Edielportalens Excel/CSV för 1.3.4. Testet ska skapa en PRODAT/Z03 med flera LIN-block i samma fil.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        description:
          "Byggs från importerad portaltestdata. En PRODAT-fil ska innehålla flera LIN-block.",
      },
      {
        stepNo: 2,
        direction: "inbound",
        ...
        title: "Ta emot positiv CONTRL",
        description:
          "Syntaxen ska vara korrekt även när PRODAT innehåller flera LIN-block.",
      },
      {
        stepNo: 3,
        direction: "inbound",
        ...
        title: "Ta emot negativ APERAK",
        description:
          "Portalen ska avvisa den anläggning/rad där datumet är felaktigt enligt testfallet.",
      },
    ],
    notes: [
...

  {
    ...
    testDataHint:
      "Testkund 9. Avtal startdatum ska vara för gammalt: 20030801.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        code: "Z03",
        required: true,
        title: "Skicka PRODAT Z03 med fel datum",
        description: "Avtal startdatum sätts till 200308010000.",
      },
      {
        stepNo: 2,
        direction: "inbound",
      ...
      },
      {
        ...
        required: true,
        title: "Ta emot negativ APERAK",
        description: "Förväntat fel: ERC 42, FTX-kod 210.",
      },
    ],
    notes: [
      "Kör 1.3.4B om systemet inte ska skicka flera anläggningar i samma PRODAT-fil.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    testCaseCode: "1.4.2",
    title:
      "Skicka negativ APERAK på inkommande felaktig Z04 med flera anläggningar",
    approvalVersion: "TGT 6.0.5 / Edielportalen 4.1",
    market: "el",
    source: "TGT_PRODAT_UTILTS_6_0_5",
    scope: "core",
    status: "ready_for_file_engine",
    purpose:
      "Verifierar att GridCore kan hantera ordinarie S1.4.2 med flera anläggningar i samma Z04 och skicka negativ APERAK där en anläggning accepteras och övriga avvisas med rätt Ediel-felkoder.",
    testDataHint:
      "Testkund 12, 13 och 14. Inbound Z04 från portalen ska besvaras med CONTRL och negativ APERAK enligt 1.4.2.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        code: "Z03",
        required: true,
        title: "Skicka korrekt PRODAT Z03",
        description:
          "Startar testet med korrekt Z03 enligt ordinarie 1.4.2-testdata.",
      },
      {
        stepNo: 2,
        direction: "inbound",
        ...
        required: true,
        title: "Ta emot positiv CONTRL",
        description: "Portalens syntaxkvittens på Z03.",
      },
      {
        stepNo: 3,
        direction: "inbound",
        ...
        required: true,
        title: "Ta emot positiv APERAK",
        description: "Portalens applikationskvittens på Z03.",
      },
      {
        stepNo: 4,
        direction: "inbound",
        ...
        code: "Z04",
        required: true,
        title: "Ta emot felaktig PRODAT Z04 med flera anläggningar",
        description:
          "Portalen skickar Z04 med flera anläggningar enligt testkund 12, 13 och 14.",
      },
      {
        stepNo: 5,
        direction: "outbound",
        ...
        required: true,
        title: "Skicka CONTRL",
        description: "Syntaxkvittens på inkommande Z04.",
      },
      {
        stepNo: 6,
        direction: "outbound",
        ...
        required: true,
        title: "Skicka negativ APERAK",
        description: "Använd preset 1.4.2 i inboundpanelen.",
      },
    ],
    notes: [
  ...
  },
  {
    ...
    status: "ready_for_file_engine",
    purpose:
      "Verifierar att GridCore avvisar Z04 med saknad ärendereferens, årsförbrukning, konstant samt fel startdatum.",
    testDataHint:
      "Testkund 12. Inbound Z04 från portalen ska besvaras med CONTRL och negativ APERAK.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        required: true,
        title: "Skicka korrekt PRODAT Z03",
        description: "Startar testet med korrekt Z03 enligt testkund 12.",
      },
      {
        stepNo: 2,
        direction: "inbound",
      ...
      },
      {
        ...
        code: "Z04",
        required: true,
        title: "Ta emot felaktig PRODAT Z04",
        description: "Portalen skickar Z04 med fördefinierade fel.",
      },
      {
        stepNo: 5,
        direction: "outbound",
      ...
      },
      {
        ...
        required: true,
        title: "Skicka negativ APERAK",
        description: "Använd preset 1.4.2/1.4.2B i inboundpanelen.",
      },
    ],
    notes: [
      "Om ni kan hantera flera anläggningar i samma fil kan även 1.4.2 köras senare.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    status: "ready_for_file_engine",
    purpose:
      "Verifierar negativ APERAK för Z04D där referens till anläggning saknas.",
    testDataHint:
      "Testkund 19. Inbound Z04D ska få negativ APERAK med ERC 41 och FTX-kod 319.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "inbound",
        ...
        code: "Z04",
        required: true,
        title: "Ta emot felaktig PRODAT Z04D",
        description: "Portalen skickar Z04D enligt testkund 19.",
      },
      {
        stepNo: 2,
        direction: "outbound",
        ...
        required: true,
        title: "Skicka CONTRL",
        description: "Syntaxkvittens på Z04D.",
      },
      {
        stepNo: 3,
        direction: "outbound",
        ...
        required: true,
        title: "Skicka negativ APERAK",
        description: "Använd preset 1.4.3 i inboundpanelen.",
      },
    ],
    notes: [
      "Rör inte positiv Z04D-baseline från S1.2.5. Detta är ett separat feltest.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    status: "ready_for_file_engine",
    purpose:
      "Verifierar att GridCore skickar negativ CONTRL vid syntaxfel och sedan hanterar korrigerad omsändning.",
    testDataHint:
      "Testkund 12. Portalen skickar först Z04 med fel UNT och saknad BGM/1004, därefter korrekt omsändning.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        required: true,
        title: "Skicka korrekt PRODAT Z03",
        description: "Startar testet enligt testkund 12.",
      },
      {
        stepNo: 2,
        direction: "inbound",
      ...
      },
      {
        ...
        required: true,
        title: "Ta emot positiv APERAK",
        description: "Portalens positiva APERAK på Z03.",
      },
      {
        stepNo: 4,
        direction: "inbound",
        ...
        code: "Z04",
        required: true,
        title: "Ta emot syntaxfelaktig Z04",
        description:
          "Portalens första Z04 har fel antal segment i UNT och saknar BGM/1004.",
      },
      {
        stepNo: 5,
        direction: "outbound",
        ...
        outcome: "negative",
        required: true,
        title: "Skicka negativ CONTRL",
        description: "Använd negativ CONTRL-knappen i inboundpanelen.",
      },
      {
        stepNo: 6,
        direction: "inbound",
        ...
        code: "Z04",
        required: true,
        title: "Ta emot korrigerad Z04",
        description: "Portalen skickar om korrekt Z04.",
      },
      {
        stepNo: 7,
        direction: "outbound",
        ...
        outcome: "positive",
        required: true,
        title: "Skicka positiv APERAK på korrigerad Z04",
        description: "Positiv APERAK efter korrigerad omsändning.",
      },
    ],
    notes: [
      "Portalen begär inte CONTRL på dessa Z04, men testet kräver negativ CONTRL på syntaxfel.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    status: "ready_for_file_engine",
    purpose:
      "Verifierar PRODAT Z06F för ändring av avräkningsmetod, mätmetod och rapporteringsfrekvens.",
    ...
    expectedSteps: [
      {
        ...
        code: "Z06",
        required: true,
        title: "Skicka PRODAT Z06F",
        description: "Z06F med E64 som transaktionstyp.",
      },
      {
        stepNo: 2,
        direction: "inbound",
        ...
        required: true,
        title: "Ta emot positiv CONTRL",
        description: "Portalens syntaxkvittens.",
      },
      {
        stepNo: 3,
        direction: "inbound",
        ...
        required: true,
        title: "Ta emot positiv APERAK",
        description: "Portalens positiva APERAK.",
      },
    ],
    notes: [
      "Z06 är drift/ändringsflöde och ska inte blandas ihop med S1.2 positiva uppstartstester.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    expectedSteps: [
      {
        ...
        required: true,
        title: "Skicka PRODAT Z06F",
        description: "Z06F med räkneverkskod/tidsintervall.",
      },
      {
        stepNo: 2,
        direction: "inbound",
    ...
    notes: [
      "Räkneverkskoden visas i UI som både kod och betydelse när kodlistan finns.",
    ],
  },
  {
    suite: "PRODAT",
    ...
    testDataHint:
      "Driftstest S2.1.3. Skapa PRODAT Z06G med E32 som transaktionstyp.",
    expectedSteps: [
      {
        stepNo: 1,
        direction: "outbound",
        ...
        code: "Z06",
        required: true,
        title: "Skicka PRODAT Z06G",
        description: "Z06G för ändrad anläggningsadress.",
      },
      {
        stepNo: 2,
        direction: "inbound",
