...
export const DEFAULT_EMAIL_EVENT_RULES = [
  ...
  { event_key: 'contract.power_of_attorney_required', template_key: 'contract.power_of_attorney_required' },
  { event_key: 'contract.facility_id_required', template_key: 'contract.facility_id_required' },
  { event_key: 'contract.customer_information_required', template_key: 'contract.customer_information_required' },
  { event_key: 'contract.completion_reminder', template_key: 'contract.completion_reminder' },
  { event_key: 'contract.rejected', template_key: 'contract.rejected' },
  { event_key: 'contract.manual_review', template_key: 'contract.manual_review' },
...
const EVENT_ALIASES: Record<string, string> = {
  ...
  missing_customer_information: 'contract.customer_information_required',
  missing_facility_id: 'contract.facility_id_required',
  missing_power_of_attorney: 'contract.power_of_attorney_required',
  contract_rejected: 'contract.rejected',
  contract_manual_review: 'contract.manual_review',
