...
const PERMISSION_CATALOG: BehörighetCatalogItem[] = [
  ...
  },
  {
    ...
    label: 'Skapa avtalsutkast',
    description: 'Kan skapa nya avtalsutkast i den canonical avtalsmodellen.',
    area: 'Avtal',
    risk: 'high',
  },
  {
    key: 'contracts.edit_draft',
    label: 'Redigera avtalsutkast',
    description: 'Kan redigera olåsta avtalsutkast men inte publicerade versioner.',
    area: 'Avtal',
    risk: 'high',
  },
  {
    key: 'contracts.create_version',
    label: 'Skapa avtalsversion',
    description: 'Kan skapa en ny immutable version i en befintlig produktserie.',
    area: 'Avtal',
    risk: 'high',
  },
  {
    key: 'contracts.publish',
    label: 'Publicera avtal',
    description: 'Kan publicera en readiness-godkänd avtalsversion.',
    area: 'Avtal',
    risk: 'high',
  },
  {
    key: 'contracts.pause',
    label: 'Pausa avtal',
    description: 'Kan pausa försäljningskanaler för en avtalsversion.',
    area: 'Avtal',
    risk: 'high',
  },
  {
    key: 'contracts.archive',
    label: 'Arkivera avtal',
    description: 'Kan stänga alla kanaler och arkivera en avtalsprodukt med historik bevarad.',
    area: 'Avtal',
    risk: 'high',
  },
  {
    key: 'contracts.delete_unused',
    label: 'Radera oanvända avtalsutkast',
    description: 'Kan permanent radera helt oanvända utkast efter dependency-kontroll.',
    area: 'Avtal',
    risk: 'high',
  },
  {
