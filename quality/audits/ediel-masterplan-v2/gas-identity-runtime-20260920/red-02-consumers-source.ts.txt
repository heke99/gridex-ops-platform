...
for(const alphabet of alphabets)for(const [code,reason,subtype] of [['Z04','Z22','L'],['Z06','E64','F'],['Z10','E58','M']])it(`actual canonical field owner compares supplied identity ${code} ${alphabet}`,()=>{
...
for(const [code,reason,subtype] of [['Z04','Z22','L'],['Z06','E64','F'],['Z10','E58','M']])it(`actual existing renderer keeps missing R, optional omission and EL boundary ${code}`,()=>{
