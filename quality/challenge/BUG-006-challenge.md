...
Finding: Registry and generated contract are not one canonical representation. Source re-read: lib/api/publicRouteRegistry.ts:1-67; docs/openapi/customer-portal-v1.json:1479; lib/integrations/openApiReleaseManifest.ts:35-63. Requirement: REQ-006.
...
Defense: OpenAPI may be independently curated and missing metadata need not affect runtime behavior.
