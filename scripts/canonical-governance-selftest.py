...
def selection():
    ...
    assert data['totalMigrations'] == 600 and data['counts'] == {'FULL_FILE_SELECTED':555,'SUBSTITUTED':23,'UNCLASSIFIED':17,'EXPLICITLY_EXCLUDED':5}, data['counts']
    ...
    assert counts == {'FULL_FILE_SELECTED':310,'SUBSTITUTED':20,'UNCLASSIFIED':11,'EXPLICITLY_EXCLUDED':5}, counts
    return order[:30]
