...
def selection():
    ...
    assert data['totalMigrations'] == 596 and data['counts'] == {'FULL_FILE_SELECTED':537,'SUBSTITUTED':23,'UNCLASSIFIED':32,'EXPLICITLY_EXCLUDED':4}, data['counts']
    ...
    assert counts == {'FULL_FILE_SELECTED':294,'SUBSTITUTED':20,'UNCLASSIFIED':24,'EXPLICITLY_EXCLUDED':4}, counts
    return order[:30]
