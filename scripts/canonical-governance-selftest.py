...
def selection():
    ...
    assert data['totalMigrations'] == 598 and data['counts'] == {'FULL_FILE_SELECTED':544,'SUBSTITUTED':23,'UNCLASSIFIED':27,'EXPLICITLY_EXCLUDED':4}, data['counts']
    ...
    assert counts == {'FULL_FILE_SELECTED':301,'SUBSTITUTED':20,'UNCLASSIFIED':19,'EXPLICITLY_EXCLUDED':4}, counts
    return order[:30]
