...
def selection():
    ...
    assert data['totalMigrations'] == 594 and data['counts'] == {'FULL_FILE_SELECTED':523,'SUBSTITUTED':24,'UNCLASSIFIED':43,'EXPLICITLY_EXCLUDED':4}, data['counts']
    ...
    assert counts == {'FULL_FILE_SELECTED':280,'SUBSTITUTED':21,'UNCLASSIFIED':35,'EXPLICITLY_EXCLUDED':4}, counts
    return order[:30]
