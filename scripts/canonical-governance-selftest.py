...
def selection():
    ...
    assert data['totalMigrations'] == 596 and data['counts'] == {'FULL_FILE_SELECTED':538,'SUBSTITUTED':23,'UNCLASSIFIED':31,'EXPLICITLY_EXCLUDED':4}, data['counts']
    ...
    assert counts == {'FULL_FILE_SELECTED':295,'SUBSTITUTED':20,'UNCLASSIFIED':23,'EXPLICITLY_EXCLUDED':4}, counts
    return order[:30]
