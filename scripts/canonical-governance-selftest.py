...
def selection():
    ...
    assert data['totalMigrations'] == 600 and data['counts'] == {'FULL_FILE_SELECTED':552,'SUBSTITUTED':23,'UNCLASSIFIED':20,'EXPLICITLY_EXCLUDED':5}, data['counts']
    ...
    assert counts == {'FULL_FILE_SELECTED':309,'SUBSTITUTED':20,'UNCLASSIFIED':12,'EXPLICITLY_EXCLUDED':5}, counts
    return order[:30]
