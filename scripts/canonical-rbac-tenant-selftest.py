...
insert into roles(id,key,name) values
 ...
 ('40000000-0000-0000-0000-000000000003','platform_admin','Platform admin') on conflict (key) do nothing;
insert into permissions(id,key,name) values
 ...
 ('50000000-0000-0000-0000-000000000004','customers.read','Customer read') on conflict (key) do nothing;
insert into role_permissions(id,role_id,permission_id) values
 ('60000000-0000-0000-0000-000000000001',(select id from roles where key='company_admin'),(select id from permissions where key='tenants.write')),
 ('60000000-0000-0000-0000-000000000002',(select id from roles where key='company_admin'),(select id from permissions where key='customers.read')),
 ('60000000-0000-0000-0000-000000000003',(select id from roles where key='member'),(select id from permissions where key='roles.manage')),
 ('60000000-0000-0000-0000-000000000004',(select id from roles where key='platform_admin'),(select id from permissions where key='tenants.write')),
 ('60000000-0000-0000-0000-000000000005',(select id from roles where key='platform_admin'),(select id from permissions where key='permissions.manage')),
 ('60000000-0000-0000-0000-000000000006',(select id from roles where key='platform_admin'),(select id from permissions where key='roles.manage'));
insert into user_roles(id,user_id,company_id,role_id,status) values
 ('70000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000003','20000000-0000-0000-0000-000000000002',(select id from roles where key='member'),'active'),
 ('70000000-0000-0000-0000-000000000002','10000000-0000-0000-0000-000000000005','20000000-0000-0000-0000-000000000001',(select id from roles where key='company_admin'),'inactive'),
 ('70000000-0000-0000-0000-000000000003','10000000-0000-0000-0000-000000000007',null,(select id from roles where key='platform_admin'),'active');
