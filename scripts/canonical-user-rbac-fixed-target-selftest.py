...
replay = load('fixed_replay', 'canonical-auth-provisioning-replay.py').controller()
...
private_inputs = replay.load_private()
MemoryAdmission = private_inputs.MemoryAdmission
AcceptedInputs = private_inputs.AcceptedInputs
