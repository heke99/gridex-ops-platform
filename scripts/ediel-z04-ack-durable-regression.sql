...
BEGIN
 ...
 INSERT INTO public.communication_routes(id,company_id,route_name,route_scope,route_type,environment_type,is_active)
 VALUES(route,c,'Synthetic ACK route','ediel_ack','ediel_partner','bilateral_test',true);
