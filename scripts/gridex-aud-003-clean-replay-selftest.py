...
''')
    ...
    def test_invalid_scope_allocates_no_temporary_paths(self):
        for arguments in (('--unsupported',), ('--readiness-prefix-proof','74'), ('--readiness-prefix-proof','--operations-prefix-proof'), ('--operations-prefix-proof','71'), ('--operations-prefix-proof','--alignment-prefix-proof'), ('--foundation-prefix-proof', 'extra'), ('--foundation-prefix-proof','--repair-prefix-proof'), ('--foundation-prefix-proof','--dedupe-prefix-proof'), ('--repair-prefix-proof','--dedupe-prefix-proof'), ('--dedupe-prefix-proof','57'), ('--dedupe-prefix',), ('--repair-prefix-proof','56'), ('--alignment-prefix-proof','68'), ('--alignment-prefix-proof','--fixed-target-prefix-proof')):
    ...
    def test_all_named_scopes_reach_staging_without_artifacts(self):
        for flag in ('--foundation-prefix-proof','--repair-prefix-proof','--dedupe-prefix-proof','--fixed-target-prefix-proof','--alignment-prefix-proof','--operations-prefix-proof','--readiness-prefix-proof'):
