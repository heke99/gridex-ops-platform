...
includes('lib/integrations/websiteIntegrationContract.ts', ["WEBSITE_INTEGRATION_CONTRACT_VERSION = '2026-08-02.1'"], 'Canonical runtime contract version ska vara 2026-08-02.1')
...
for (const rel of ['docs/openapi/website-integration-v1.json']) {
  const spec = json(rel)
  check(spec.info?.version === '2026-08-02.1', `${rel} ska ha version 2026-08-02.1`)
