...
check(websiteSpec.info?.version === '2026-07-28.2', 'Website OpenAPI ska rapportera 2026-07-28.2')
check(portalSpec.info?.version === '2026-07-28.2', 'Customer portal OpenAPI ska rapportera 2026-07-28.2')
...
includes('lib/integrations/websiteIntegrationContract.ts', ["WEBSITE_INTEGRATION_CONTRACT_VERSION = '2026-07-28.2'"], 'Runtime och dokumentation ska ha samma canonicala kontraktsversion')
