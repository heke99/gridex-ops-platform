...
check(websiteSpec.info?.version === '2026-08-01.1', 'Website OpenAPI ska rapportera 2026-08-01.1')
check(portalSpec.info?.version === '2026-08-01.1', 'Customer portal OpenAPI ska rapportera 2026-08-01.1')
...
includes('lib/integrations/websiteIntegrationContract.ts', ["WEBSITE_INTEGRATION_CONTRACT_VERSION = '2026-08-01.1'"], 'Runtime och dokumentation ska ha samma canonicala kontraktsversion')
