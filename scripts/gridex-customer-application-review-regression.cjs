...
assert(hardeningMigration.includes('customers_intake_status_check') && hardeningMigration.includes('ready_for_operations') && !hardeningMigration.includes("'missing_fields'") === false, 'hardening migration remaps old invalid customer intake statuses before recreating constraint')
