...
class DB2DispositionTest(unittest.TestCase):
    ...
    def test_db2_exact_source_is_excluded_without_selecting_schema_companions(self):
        ...
        self.assertEqual(report['counts'], {'FULL_FILE_SELECTED': 552, 'SUBSTITUTED': 23,
                                          'UNCLASSIFIED': 20, 'EXPLICITLY_EXCLUDED': 5})
        self.assertEqual(report['selectedInputCounts'], {'foundation': 112, 'timestamp': 508})
