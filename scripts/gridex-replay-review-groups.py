...
DOMAIN_WORDS = {
    'auth_membership_tenant': r'auth|membership|tenant|company|user_profile|invite|invitation|password|role|permission|canonical_user_rbac_repair_boundary|canonical_user_rbac_fixed_target_|canonical_user_rbac_customer_alignment_(?:prerequisites|boundary)',
