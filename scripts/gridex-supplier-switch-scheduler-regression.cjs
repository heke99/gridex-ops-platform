...
assert(scheduler.includes('SUPPLIER_SWITCH_WINDOW_OPEN_LEAD_DAYS'), 'scheduler defines explicit send-window lead policy')
...
for (const code of ['supplier_switch_send_window_not_open', 'duplicate_active_supplier_switch', 'unresolved_negative_ack']) {
