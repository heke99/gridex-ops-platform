...
jq -e --arg tenant "$EXPECTED_TENANT_REFERENCE" '.meta.tenant_reference == $tenant and .meta.contract_schema_version == "2026-08-03.1"' "$TMP/contracts.json" >/dev/null
jq -e '.release_version == "2026-08-03.1" and .website_openapi_version == "2026-08-03.1" and .customer_portal_openapi_version == "2026-08-03.1"' "$TMP/manifest.json" >/dev/null
