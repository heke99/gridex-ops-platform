...
class NativeLifecycleIntegrationTests(unittest.TestCase):
    ...
    def execute(self, fail=False, cleanup=False, legacy_fail=False, repair_fail=False, provider_fail=False, dedupe_fail=False, fixed_fail=False, alignment_fail=False, tail_fail=False, timestamp_fail=False):
        ...
        import canonical_added_nonunique_index_decisions as nonunique
        import canonical_removed_policy_qualification as removed_policies
        def apply_timestamp(command,cli,sql,work,project,parent,plan,forward_retained,view_retained,removed_policy_retained,changed_view_retained,changed_function_retained,changed_index_retained,intake_retained,nonunique_retained):
            ...
            self.assertIs(intake_retained,self.intake_retained)
            self.assertIs(nonunique_retained,self.nonunique_retained)
