...
begin
  ...
  where n.nspname='public' and not c.convalidated and c.contype in ('f','c');
  ...
  loop
    execute format('alter table %I.%I validate constraint %I',v_constraint.schema_name,v_constraint.table_name,v_constraint.constraint_name);
  end loop;
