-- Preserve the existing merged customer/domain event feed while moving
-- pagination into PostgreSQL. Internal event UUIDs remain server-only and are
-- carried only inside the encrypted cursor/public-reference mapper.
