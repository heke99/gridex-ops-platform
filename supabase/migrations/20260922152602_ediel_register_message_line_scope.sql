-- Created by actual Supabase CLI; forward correction of message-local LIN identity.
-- Preserve the existing owner, signature, grants, checks and global segment uniqueness.
