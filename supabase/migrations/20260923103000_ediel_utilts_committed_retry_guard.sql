-- Preserve already emitted transaction responses and stored meter series when a
-- later processing pass sees different structural authority. Same-result retry
-- remains idempotent; a held/unfinalized transaction can still be approved.
BEGIN;
