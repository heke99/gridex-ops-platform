-- Prospective archive timing on already captured process rows. No pre-epoch completeness.
...
DECLARE
 ...
 fields text[]:=ARRAY[
  ...
  'happened_at','occurred_at','created_at','updated_at','archived_at','source_type','operation_id',
