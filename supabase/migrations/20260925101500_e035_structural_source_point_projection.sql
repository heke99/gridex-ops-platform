-- The same sealed source ledger receives Z06/Z10 structural changes. Rebuild
-- the stored projection after expanding the immutable parser; generated values
-- do not recalculate merely because a function body changes.
BEGIN;
