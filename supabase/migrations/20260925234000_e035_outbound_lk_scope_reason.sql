-- Preserve the bounded canonical LK exemption with an explicit database-owned reason.
-- The H dispatch fence still holds malformed originals before provider entry.
BEGIN;
